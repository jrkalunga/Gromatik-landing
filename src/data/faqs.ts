...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Trabajamos con la información que tengas disponible: registros de rodeo, datos de manejo, sanidad, alimentación y resultados productivos y económicos. Te guiamos en el proceso.",
  },
  {
    question: "¿La conversación inicial tiene costo?",
    answer:
      "No. Es un primer encuentro para entender tu situación y mostrarte cómo te acompañaríamos en tu establecimiento.",
  },
  {
